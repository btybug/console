...
use Btybug\btybug\Helpers\helpers;
use Btybug\btybug\Helpers\helpers;
use Btybug\btybug\Models\Templates as Tpl;
use Btybug\btybug\Models\TplVariations;
...
class HfController extends Controller
{
    ...
    public function TemplatePerviewEditIframe($id)
    {
        ...
        $settings_json = json_encode($settings, true);
        return view('console::backend.gears.templates.if_edit_preview', compact(['htmlBody', 'htmlSettings', 'settings_json', 'id', 'settings']));
    }
    ...
    public function postGetVariations(Request $request)
    {
        ...
        $variation = Tpl::findVariation($id);
        $slug = explode('.', $id);
        $html = View::make('console::backend.gears.templates._partrials.edit_variation', compact(['variation', 'slug']))->render();
    ...
    {
        return view('console::backend.gears.templates.tplsample');
    }
