...
class UnitsController extends Controller
{
    ...
    public function unitPreview($id)
    {
        ...
        $ifrem['body'] = url('/admin/console/backend/units/settings-iframe', $id);
        $ifrem['settings'] = url('/admin/console/backend/units/settings-iframe', $id) . '/settings';
...
//        if (!$variation) return redirect()->back();
        ...
        return view('console::backend.gears.units._partials.unit_preview', compact(['htmlBody', 'htmlSettings', 'settings', 'settings_json', 'id', 'ui']));
    }
