                            ...
                            <tr>
                                ...
                                <td>
                                    @if( $template->type=="widget")
                                        <a href="/admin/console/backend/h-f/widget-settings/{{$variation_data->id}}"
                                           class="btn btn-default btn-warning btn-xs">&nbsp;<i class="fa fa-cog"></i>&nbsp;</a>
                                    @endif
                                    <a href="/admin/console/backend/h-f/settings-live/{{$variation_data->id}}"
                                       class="btn btn-default btn-warning btn-xs">&nbsp;<i class="fa fa-cog"></i>&nbsp;</a>
                                    @if(!$variation_data->main)
                                        ...
                                        <a href="/admin/console/backend/h-f/delete-variation/{{$variation_data->id}}/{{$template->id}}"
