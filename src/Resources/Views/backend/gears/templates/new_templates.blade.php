                ...
                <div class="row templates m-b-10">
                    ...
                    <div class="col-xs-12 templates-header p-t-10 p-b-10">
                        <span class="pull-left templates-title f-s-15 col-xs-6 col-sm-6 col-md-6 col-lg-6 p-l-0  "><i
                                    class="fa fa-bars f-s-13 m-r-5" aria-hidden="true"></i>  Test</span>
                        ...
                        <div class="row templates m-b-10">
                            <div class="col-xs-12 p-l-0 p-r-0">
                                ...
                                <div class="tempalte_icon">
                                    <div><a href="#" class="addons-settings  m-r-10"><i class="fa fa-eye f-s-14"></i>
                                        </a></div>
                                    <div><a href="#" class="addons-deactivate  m-r-10"><i
                                                    class="fa fa-pencil f-s-14"></i> </a></div>
                                    <div><a href="#" class="addons-delete"><i class="fa fa-trash-o f-s-14 "></i> </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 templates-header p-t-10 p-b-10">
                                <span class="col-xs-12 templates-title f-s-15 text-center"><i
                                            class="fa fa-bars f-s-13 m-r-5" aria-hidden="true"></i>  Test</span>
