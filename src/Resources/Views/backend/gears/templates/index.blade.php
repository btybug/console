...
@section('content')
    ...
    <div>
        ...
        <a href="/admin/templates/start">
            <button class="btn btn-sm btn-success mrg-btm-10" type="button"><i class="fa fa-wrench"></i>&nbsp; Start New
                Template
            </button>
        </a>
        <button class="btn btn-sm btn-primary pull-right mrg-btm-10" type="button" data-toggle="modal"
                data-target="#uploadfile"><i class="fa fa-upload"></i>&nbsp; Upload
        </button>
    </div>
    <div class="row">
