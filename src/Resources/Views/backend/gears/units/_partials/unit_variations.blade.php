@if($unit)
    <a href="{!! url('/admin/console/backend/units/settings', $unit->slug) !!}" id="viewType" class="col-xs-4 add_unit_variation">
                    ...
                    <div class="tempalte_icon">
                        ...
                        @if($ui->default == 0)
                            <div>
                                ...
                                <a data-href="{!! url('/admin/console/backend/units/delete-variation') !!}" data-key="{!! $ui->id !!}" data-type="Unit Variation"  class="delete-button addons-delete delete_layout"><i
