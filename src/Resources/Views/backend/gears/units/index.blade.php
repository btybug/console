                    ...
                    <div class="template-upload-button clearfix">
                        ...
                        <ul class="editIcons list-unstyled ">
                            @if($unit && !$unit->is_core)
                                <li>
                                    <a data-href="{!! url('/admin/console/backend/units/delete') !!}" data-key="{!! $unit->slug !!}" data-type="Unit" class="delete-button btn trashBtn"><i class="fa fa-trash-o"></i></a>
                                </li>
                            @endif
                        ...
                        <button class="btn btn-sm pull-right btnUploadWidgets" type="button" data-toggle="modal"
                            ...
                            <i class="fa fa-cloud-upload module_upload_icon"></i> <span class="upload_module_text">Upload Units</span>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="templates-list  m-t-20 m-b-10">
                <div class="row m-b-10">
                    ...
                    <div class="raw tpl-list">
                        @include('console::backend.gears.units._partials.unit_variations')
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url'=>'/admin/console/backend/units/upload','class'=>'dropzone', 'id'=>'my-awesome-dropzone']) !!}
            ...
            <script>
                ...
                function confirm_delete(data){
                    ...
                    if (r == true) {
                        ...
                        $.ajax({
                            url: '/admin/console/backend/units/delete',
                            data: {
                                slug: slug
                            },headers: {
