<div class="row toolbarNav">
					...
					<div class="col-xs-6 left-side">
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane general active p-10" id="general" data-formsetting="setting">
								...
								<label for="lableedit"><i class="fa fa-play mr-5 f-12"></i> Label Name</label><input class="form-control" id="lableedit" data-field="lable" placeholder="Text here" name="label" value="Singleline" type="text">
								</div>
							
								<div class="form-group"><label for="EditFieldTitle"><i class="fa fa-play mr-5 f-12"></i> Field name</label><input class="form-control" id="EditFieldTitle" data-field="lable" placeholder="Text here" name="name" value="Singleline" type="text">
								</div>
								<div class="form-group"><label for="EditFieldInvale"><i class="fa fa-play mr-5 f-12"></i> Default Text</label><input class="form-control" id="EditFieldInvale" data-field="input" name="default_value "  placeholder="Default Text " value="" type="text">
								</div>
								<div class="form-group">
								<label for="placeholder"><i class="fa fa-play mr-5 f-12"></i> placeholder</label><input class="form-control" id="placeholder" data-field="lable" placeholder="Text here" name="placeholder" value="Singleline" type="text">
								</div>
							</div>
				...
				<input class="form-control hide" id="lableedit" data-field="lable" placeholder="Text here" name="type" value="text" type="text">
