	...
	<div class="col-xs-6 left-side">
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane general p-10 active" id="general" data-formsetting="setting">
				<div class="form-group"><label for="EditFieldTitle"><i class="fa fa-play mr-5 f-12"></i> Field Title</label><input class="form-control" id="EditFieldTitle" data-field="lable" placeholder="Text here" value="Check buttons" type="text">
				</div>
			...
			<div class="form-group datafrom" data-type="checkbuttons">
				<div class="row">
					...
					<div data-fcontrol="input">
						<div class="checkbox">
							<input value="checkbox 1" type="checkbox">
							<label> checkbox 1 </label>
						</div>
						<div class="checkbox">
							<input value="checkbox 2" type="checkbox">
							<label> checkbox 1 </label>
						</div>
					</div>
				</div>
