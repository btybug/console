	...
	<div class="col-xs-6 left-side">
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane general active p-10" id="general" data-formsetting="setting">
				<div class="form-group"><label for="EditFieldTitle"><i class="fa fa-play mr-5 f-12"></i> Field Title</label><input class="form-control" id="EditFieldTitle" data-field="lable" placeholder="Text here" value="Multiline" type="text">
				</div>
				<div class="form-group"><label for="EditFieldInvale"><i class="fa fa-play mr-5 f-12"></i> Default Text</label><input class="form-control" id="EditFieldInvale" data-field="input" placeholder="Default Text " value="" type="text">
				</div>
			</div>
