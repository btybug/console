    ...
    <div class="layout clearfix">
        ...
        <div class="layoutData">
            <div class="layoutCol">
                ...
                @if($tpl && !$tpl->is_core)
                    <a data-href="{!! url('/admin/uploads/gears/h-f/delete') !!}" data-key="{!! $tpl->slug !!}" data-type="H&F" class="delete-button btn btn-danger p-a-r-10-t-0"><i class="fa fa-trash-o"></i></a>
                @endif
            </div>
            <div class="layoutFooter row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 ">
                    <span class="textWrap"><a href="{!! @$tpl->author_site !!}" class="link"><i>{!! @$tpl->author_site !!}</i></a></span>
                </div>
