                ...
                <div class=" topRow p-l-0 p-r-0">
                    ...
                    <div class="tempalte_icon">
                        ...
                        @if(count($tpl->variations())>1)
                            <div>
                                <a data-href="{!! url('/admin/console/backend/templates/delete-variation') !!}" data-key="{!! $variation->id !!}" data-type="Template Variation"  class="delete-button addons-delete delete_layout">
