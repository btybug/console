...
@section('tab')
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cms_module_list">
            ...
            <div class=" menuBox">
                <div class="selectCat">
                    {!! Form::select('type',['header'=>'Headers','left_bar'=>'Left bar'],$type,['class' => 'selectpicker select-type','data-style' => 'selectCatMenu',' data-width' => '100%']) !!}
                </div>
            </div>
            <hr>
                        ...
                        @else
                            ...
                            @else
                                <li class="">
                                    @endif
                                    @endif
                                    <a href="?p={!! $template->slug !!}{!! ($type)? "&type=".$type : "" !!}" rel="unit"
                                       data-slug="{{ $template->slug }}" class="tpl-left-items">
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
            <div class="row">
                <div class="col-xs-12 col-sm-12 unit-box">
                    @include('console::backend.gears.tpl._partials.tpl_box')
                </div>
            </div>
                ...
                @if($tpl)
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 p-l-0 p-r-0">
                        <div class="template-upload-button clearfix">
                            ...
                            <a href="{!! url('/admin/console/backend/templates/settings',$tpl->slug) !!}" id="viewType"
            ...
            <div class="templates-list  m-t-20 m-b-10">
                <div class="row m-b-10">
                    ...
                    <div class="raw tpl-list">
                        @if($tpl)
                            @include('console::backend.gears.tpl._partials.tpl_variations')
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url'=>'/admin/console/backend/templates/upload','class'=>'dropzone', 'id'=>'my-awesome-dropzone']) !!}
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
