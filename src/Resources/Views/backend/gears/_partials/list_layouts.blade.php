            ...
            <div class="row templates m-b-10 ">
                <div class=" topRow p-l-0 p-r-0">
                    ...
                    <div class="tempalte_icon">
                        <div><a href="{!! url('/admin/settings/admin-templates/settings',$ui->slug) !!}"
                                class="m-r-10"><i class="fa fa-pencil f-s-14"></i> </a></div>
                        @if($ui->default == 0)
                            <div>
                                <a href="{!! url('admin/settings/pages-layout/delete',$ui->slug) !!}"  data-key="{!! $ui->slug !!}" type={!! $ui->type !!}""
                                        main_type="{!! @$ui->main_type !!}" class="addons-delete delete_layout"><i
                                            class="fa fa-trash-o f-s-14 "></i>
                                </a>
                ...
                {{--///admin/settings/pages-layout/delete--}}
               {{-- <span>{{ isset($url) ? $url : '' }}</span>--}}
                <div class=" templates-header ">
                    <span class=" templates-title text-center"><i class="fa fa-bars f-s-13 m-r-5"
                                                                                  aria-hidden="true"></i> {!! $ui->name or $ui->slug !!}</span>
                    <div class=" templates-buttons text-center ">
                        <span class="authorColumn"><i class="fa fa-user author-icon" aria-hidden="true"></i>
                        author:{!! $ui->author or null !!}</span> <span class="dateColumn"><i class="fa fa-calendar calendar-icon" aria-hidden="true"></i> {!! BBgetDateFormat($ui->created_at) !!}</span>
