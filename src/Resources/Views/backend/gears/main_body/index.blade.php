    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cms_module_list">
            ...
            <div class=" menuBox">
                ...
                <div class="selectCat">
                    {!! Form::select('type',[],'',['class' => 'selectpicker select-type','data-style' => 'selectCatMenu',' data-width' => '100%']) !!}
                </div>
            </div>
            <hr>
            ...
            <div class="row template-search">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 p-l-0 p-r-0">
                    <div class="template-upload-button clearfix">
                        ...
                        <a href="{!! url('/admin/settings/admin-templates/settings',$unit->slug) !!}" class="btn btn-sm pull-right btnUploadWidgets" type="button"
            ...
            <div class="templates-list  m-t-20 m-b-10">
                <div class="row m-b-10">
                    ...
                    <div class="raw tpl-list">
                        @include('console::backend.gears._partials.tpl_variations')
                    </div>
                </div>
            </div>
