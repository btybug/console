@extends('layouts.mTabs',['index'=>'backend_console'])
@section('tab')
    <div class="row">
                        ...
                        <div class="row templates m-b-10 row_template">
                            ...
                            <div class="raw tpl-list">
                                ...
                                <span class="pull-left templates-title f-s-15 col-xs-12 col-sm-12 col-md-6 col-lg-6 p-l-0 for_title_111">
                                    <i class="fa fa-bars f-s-13 m-r-5" aria-hidden="true"></i>  {!! $layout->name !!} </span>
                                        <div class="pull-right templates-buttons col-xs-12 col-sm-12 col-md-6 col-lg-6 p-r-0 text-right for_author_111">
                                            ...
                                            <span class="name_111">author:{!! $layout->author !!} , {!! BBgetDateFormat($layout->created_at) !!}</span>
                                            <span class="for_icons_111">
                                        <a href="#" class="addons-deactivate  m-r-10 edit_111"><i class="fa fa-pencil f-s-14"></i> </a>
                                        <a href="{!! url('/admin/console/backend/layouts/settings',$layout->slug) !!}" class="addons-deactivate  m-r-10 settings_111"><i class="fa fa-cog f-s-14"></i> </a>
                                        <a href="{!! url('/admin/console/backend/layouts/delete',$layout->slug) !!}" data-href="{!! url('/admin/console/backend/layouts/delete',$layout->slug) !!}" slug="#" class="addons-delete del-tpl"><i class="fa fa-trash-o f-s-14 "></i> </a>
                                    </span>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url'=>'/admin/console/backend/layouts/upload','class'=>'dropzone', 'id'=>'my-awesome-dropzone']) !!}
