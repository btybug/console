...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cms_module_list">
            ...
            <div class=" menuBox">
                <div class="selectCat">
                    {!! Form::select('type',['units'=>'Units','widget'=>'Widgets'],$type,['class' => 'selectpicker select-type','data-style' => 'selectCatMenu',' data-width' => '100%']) !!}
                </div>
            </div>
            <hr>
            <ul class="list-unstyled menuList" id="components-list">
                @if(count($templates))
                    @foreach($templates as $template)
                        @if($template)
                            @if($template->slug == $template->slug)
                                <li class="active">
                            @else
                                <li class="">
                            @endif
            ...
            <div class="templates-list  m-t-20 m-b-10">
                <div class="row m-b-10">
                    ...
                    <div class="raw tpl-list">
                        @include('uploads::gears._partials.lists_hf')
                    </div>
                </div>
            </div>
