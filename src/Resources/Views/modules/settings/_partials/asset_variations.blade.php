            ...
            <div class="row templates m-b-10 ">
                <div class=" topRow p-l-0 p-r-0">
                    ...
                    <div class="tempalte_icon">
                        <div><a href="{!! url('/admin/console/backend/' . $type . '/settings',$variation->id) !!}"
                                class="m-r-10"><i class="fa fa-pencil f-s-14"></i> </a></div>
                        @if(count($variations)>1)
                            <div>
                                <a href="{!! url('/admin/console/backend/' . $type . '/delete-variation',$variation->id) !!}"  class="addons-delete delete_layout">
