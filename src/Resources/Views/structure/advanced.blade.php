                ...
                <div class="row hide"> {!! Form::open(['id' => 'createNewForm']) !!}
                    ...
                    <div class="col-md-12">
                        <div class="alert alert-success alert-dismissable visible-xs visible-md">
                            ...
                            May not work properly in touch enabled devices as it as requires drag and drop. </div>
                        <!--form builder-->
                                ...
                                <h3 class="panel-title">
                                    <div class="navbars">
                                        <ul class="nav nav-tabs navbar-tabs" style='border-bottom: 1px solid #337AB7; '>
                                            <li data-value='bulder-form' class="active"><a href="#">Drag & Drop components</a></li>
                                            ...
                                            <form class="form-horizontal">
                                                <fieldset>
                                                    ...
                                                    <div class="form-group email-plase">
                                                        <div class="checkbox ">
                                                            <label class="checkbox">
                                                                <input type="checkbox" data-toggle="collapse" data-target="#collapseExample1"
                                                                       aria-expanded="false"
                                                            ...
                                                            <div id="collapseExample1" class="collapse">
                                                                <div class="well">
                                                                    <div>
                                                                        <label class="col-md-2 control-label" for="textinput">Admin email</label>
                                                                        <div class="col-md-4">
                                                                            <input id="textinput" name="textinput" type="text" placeholder="placeholder" class="form-control input-md">
                                                                        </div>
                                                                        <div class="col-md-2"><a href="#">Edit template</a></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="checkbox ">
                                                            <label class="checkbox">
                                                                <input type="checkbox" data-toggle="collapse" data-target="#collapseExample2"
                                                                       aria-expanded="false"
                                                                ...
                                                                <div class="well">
                                                                    <div>
                                                                        <div class="col-md-4">
                                                                            <div class="radio">
                                                                                <label for="send-0">
                                                                                    <input type="radio" name="send" id="send-0" value="1" checked="checked">
                                                                                    yes </label>
                                                                            </div>
                                                                            <div class="radio">
                                                                                <label for="send-1">
                                                                                    <input type="radio" name="send" id="send-1" value="2">
                                                                                    no </label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4"><a href="#">Edit template</a></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="checkbox ">
                                                            <label class="checkbox">
                                                                <input type="checkbox" data-toggle="collapse" data-target="#collapseExample3"
                                                                       aria-expanded="false"
                                                            ...
                                                            <div id="collapseExample3" class="collapse">
                                                                <div class="well">
                                                                    <div>
                                                                        <label class="col-md-4 control-label" for="textinput">Type your message</label>
                                                                        <div class="col-md-4">
                                                                            <input id="textinput" name="textinput" type="text" placeholder="placeholder" class="form-control input-md">
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="checkbox ">
                                                            <label class="checkbox">
                                                                <input type="checkbox" data-toggle="collapse" data-target="#collapseExample4"
                                                                       aria-expanded="false"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="checkbox ">
                                                            <label class="checkbox">
                                                                <input type="checkbox" data-toggle="collapse" data-target="#collapseExample5"
                                                                       aria-expanded="false"
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="checkbox ">
                                                            <label class="checkbox">
                                                                <input type="checkbox" data-toggle="collapse" data-target="#collapseExample6"
                                                                       aria-expanded="false"
                    ...
                    <div class="col-md-8">
                        <div class="form-horizontal">
                            <div class="form-group p-l-20">
                                ...
                                <div class="col-md-6">
                                    <input type="text" placeholder="Form Name" class="form-control" value="" id="formname" required="">
                                </div>
                                <a aria-controls="General" role="tab" data-toggle="tab" class="btn btn-default btn-dblue"> <i class="fa fa-gear"></i> Setting </a> </div>
                        </div>
                    </div>
                    <div class="col-md-4 text-right">   <a href="#" class="btn btn-default btn-default-gray" data-action="converthtml">Convert HTML</a> <a href="#" class="btn btn-default btn-default-gray">Discard</a> <a href="#" class="btn btn-danger btn-danger-red" data-value="{!!$form->id or null!!}" data-save="form">Save</a>
                        <input type="hidden" id="panelID" value="">
                    </div>
                </div>
                <div class="row toolrowsection bootbox">
                    <div class="col-md-3 tooleditsection">
                        <select class="form-control customFormSelect" id="category" data-filter="components" name="category">
                        ...
                        <div class="category-list list-group">
                            <div class="list-group-item grid-stack-item green" data-fromtype="Singleline" data-components="basic" data-gs-auto-position="true">
                                <div class="grid-stack-item-content"><i class="fa fa-minus"></i> Single-line</div>
                            </div>
                            <div class="list-group-item grid-stack-item darkpink" data-fromtype="multiline" data-components="basic" data-gs-auto-position="true">
                                <div class="grid-stack-item-content"><i class="fa fa-bars"></i> Multi-line</div>
                            </div>
                            <div class="list-group-item grid-stack-item blue" data-fromtype="Select" data-components="basic" data-gs-auto-position="true">
                                <div class="grid-stack-item-content"><i class="fa fa-arrow-down"></i> Select</div>
                            </div>
                            <div class="list-group-item grid-stack-item yellow" data-fromtype="multiSelect" data-components="basic">
                                <div class="grid-stack-item-content"><i class="fa fa-sort-amount-desc"></i> Multi-Select</div>
                            </div>
                            <div class="list-group-item grid-stack-item red" data-fromtype="rediobuttons" data-components="basic">
                                <div class="grid-stack-item-content"><i class="fa fa-dot-circle-o"></i> Redio-Buttons</div>
                            </div>
                            <div class="list-group-item grid-stack-item red" data-fromtype="checkbuttons" data-components="basic">
                                <div class="grid-stack-item-content"><i class="fa fa-check-square-o"></i> Check Boxes</div>
                            </div>
                            <div class="list-group-item grid-stack-item green" data-fromtype="slider" data-components="advance">
                                <div class="grid-stack-item-content"><i class="fa fa-sliders"></i> Slider</div>
                            </div>
                            <div class="list-group-item grid-stack-item green" data-fromtype="password" data-components="basic">
                                <div class="grid-stack-item-content"><i class="fa fa-key"></i> password</div>
                            </div>
                            <div class="list-group-item grid-stack-item green" data-fromtype="file" data-components="basic">
                                <div class="grid-stack-item-content"><i class="fa fa-upload"></i> File Upload</div>
                            </div>
                            <div class="list-group-item grid-stack-item green" data-fromtype="phone" data-components="basic">
                                <div class="grid-stack-item-content"><i class="fa fa-phone"></i> Phone Number</div>
                            </div>
                            <div class="list-group-item grid-stack-item blue" data-fromtype="email" data-components="basic" data-gs-auto-position="true">
                                <div class="grid-stack-item-content"><i class="fa fa-envelope"></i> Email</div>
                            </div>

                            <div class="list-group-item grid-stack-item blue" data-fromtype="button" data-components="basic" data-gs-auto-position="true">
                                <div class="grid-stack-item-content"><i class="fa fa-send"></i> Button</div>
                            </div>

                            <div class="list-group-item grid-stack-item darkpink" data-fromtype="rating" data-components="advance">
                                <div class="grid-stack-item-content"><i class="fa fa-star-half-o"></i> Star Rating</div>
                            </div>
                            <div class="list-group-item grid-stack-item blue" data-fromtype="spinner" data-components="advance">
                                <div class="grid-stack-item-content"><i class="fa fa-exchange"></i> Spinner</div>
                            </div>
                            <div class="list-group-item grid-stack-item darkpink" data-fromtype="time" data-components="advance">
                                <div class="grid-stack-item-content"><i class="fa fa-clock-o"></i> Time</div>
                            </div>
                            <div class="list-group-item grid-stack-item darkpink" data-fromtype="date" data-components="advance">
                                <div class="grid-stack-item-content"><i class="fa fa-calendar-o"></i> Date</div>
                            </div>
                            <div class="list-group-item grid-stack-item darkpink" data-fromtype="autocomplete" data-components="advance">
                                <div class="grid-stack-item-content"><i class="fa fa-pencil"></i> Autocomplete</div>
                            </div>

                            <div class="list-group-item grid-stack-item blue" data-fromtype="multithumb" data-components="advance">
                                <div class="grid-stack-item-content"><i class="fa fa-picture-o"></i> Multi-Thumbs</div>
                            </div>
                            <div class="list-group-item grid-stack-item yellow" data-fromtype="multithumbselect" data-components="advance">
                    ...
                    <div class="col-md-9 p-t-15 p-r-15">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="btn-group" role="group"> <a aria-controls="General" role="tab" data-toggle="tab" class="btn btn-default btn-dblue"> <i class="fa fa-mobile"></i> </a> <a aria-controls="General" role="tab" data-toggle="tab" class="btn btn-default btn-dblue"> <i class="fa fa-tablet"></i> </a> <a aria-controls="General" role="tab" data-toggle="tab" class="btn btn-default btn-dblue"> <i class="fa fa-laptop"></i> </a> <a aria-controls="General" role="tab" data-toggle="tab" class="btn btn-default btn-dblue active"> <i class="fa fa-desktop"></i> </a> </div>
                                <div class="btn-group" role="group"> <a aria-controls="General" role="tab" data-toggle="tab" class="btn btn-default btn-dblue" data-action="view"> <i class="fa fa-eye"></i> </a> </div>
                            </div>
                            <div class="col-md-4 text-center">
                                <a aria-controls="General" href=".step1" role="tab" data-toggle="tab" data-step="step1" class="btn btn-default btn-dblue active">Step 1</a>
                                <a href="#" data-action="addnewstep" class="btn btn-default btn-dblue"> <i class="fa fa-plus"></i> </a>
                                <a data-toggle="modal" data-target="#formsetting" href="#" class="btn btn-default btn-dgreen"> <i class="fa fa-gear"></i> </a>
                            </div>
                            <div class="col-md-4 text-right">
                                <button type="button" class="btn btn-default btn-danger-red btn-dgreen"  data-toggle="modal" data-target="#themes"><i class="fa fa-paint-brush"></i> Themes </button>
                                <button type="button" class="btn customeBtn collapsed" data-toggle="collapse" href="#codeCss">Custom CSS <i class="arrowDown"></i></button>
                            </div>
                        </div>
                        <div class="tab-content" data-step-container="stepcontainer">
                            <div class="tab-pane preview step1 active" role="tabpanel" >
                                ...
                                <div class="p-t-20 text-center">
                                    <button type="button" class="btn add-content-btn" data-action="addFullContainer"><i class="fa fa-plus"></i></button>
                                </div>
                        ...
                        <div class="p-10 m-t-40" style="border-top:solid 1px #ccc;">
                            <h5>Output of json <small>After complating json work remove this</small></h5>
                    ...
                    <div data-formElement="all" class="hide">
                            ...
                            <div class="form-group datafrom"  data-type="Singleline" data-size="col-sm-12">
                                <div class="row">
                                    ...
                                    <div data-fcontrol="input" class="col-sm-12" >
                                        <input type="text" class="form-control" id="singleline" placeholder="singleline">
                                    </div>
                                </div>
                            </div>
                            <div class="p-rightsection"> <a class="blue" data-action="edit" ><i class="fa fa-pencil"></i></a> <a class="yellow" data-action="clone"><i class="fa fa-clone"></i></a> <a class="red" data-action="delete"><i class="fa fa-trash"></i></a> </div>
                        ...
                        <div data-fromelement="multiSelect">
                            <div class="form-group datafrom"  data-type="multiSelect">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12"  data-fcontrol="input">
                                        <select name="multiSelect" multiple="" class="form-control" data-content="Please select an option">
                                            <option value="0" selected="selected">--- Select ---</option>
                                            <option>Option 1</option>
                                            <option>Option 2</option>
                                            <option>Option 3</option>
                        ...
                        <div data-fromelement="rediobuttons">
                            <div class="form-group  datafrom" data-type="rediobuttons">
                                <div class="row">
                                    <label for="optionsRadios" data-fcontrol="label" class="col-sm-12 control-label">Redio buttons</label>
                                    <div  data-fcontrol="input" class="col-sm-12">
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="optionsRadios" id="optionsRadios1" value="Redio 1" checked>
                                                Redio 1</label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="optionsRadios" id="optionsRadios2" value="Redio 2">
                                                Redio 2 </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="optionsRadios" id="optionsRadios3" value="Redio 3">
                                                Redio 3 </label>
                                        </div></div>
                                </div>
                            </div>
                        ...
                        <div data-fromelement="checkbuttons">
                            <div class="form-group datafrom"  data-type="checkbuttons">
                                <div class="row">
                                    ...
                                    <div data-fcontrol="input"><div class="checkbox">
                            ...
                            <div class="form-group datafrom"  data-type="slider">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12" data-fcontrol="input">
                                        ...
                                        <input type="range" name="slider" class="form-control hide" id="slider" hidden="hidden" value="50" min="0" max="100" step="1">
                                    </div>
                                </div>
                            </div>
                            <div class="p-rightsection"> <a class="blue" data-action="edit" ><i class="fa fa-pencil"></i></a> <a class="yellow" data-action="clone"><i class="fa fa-clone"></i></a> <a class="red" data-action="delete"><i class="fa fa-trash"></i></a> </div>
                        ...
                        <div data-fromelement="spinner">
                            <div class="form-group datafrom" data-type="spinner">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12" data-fcontrol="input">
                                        <div class="input-group">
                                            <input type="text" name="spinner" data-min="0" data-max="100" data-step="2" data-decimals="0" value="0" class="form-control spinner" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group datafrom" data-type="rating">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 f-s-8" data-fcontrol="input">
                                        <input  type="text" class="rating rating-loading form-control" min="0" max="5" step="1" data-stars="5" data-show-clear="false" data-show-caption="false" data-size="xl" value="0" data-empty-star="<i class='glyphicon glyphicon-star-empty'></i>" data-filled-star="<i class='glyphicon glyphicon-star'></i>">
                                    </div>
                                </div>
                            </div>
                            <div class="p-rightsection"> <a class="blue" data-action="edit" ><i class="fa fa-pencil"></i></a> <a class="yellow" data-action="clone"><i class="fa fa-clone"></i></a> <a class="red" data-action="delete"><i class="fa fa-trash"></i></a> </div>
                        ...
                        <div data-fromelement="date">
                            <div class="form-group datafrom" data-type="date">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12" data-fcontrol="input">
                                        <div class="input-group date datepicker" data-format="YYYY/MM/DD hh:mm A" data-language="en">
            ...
            <div class="modal-content">
                <div class="modal-body">
                        ...
                        <div class="col-md-8">
                            <div class="form-horizontal">
                                <div class="btn-group btn-group-justified" role="group" aria-label="..." data-tool-tab="btnpanel">
                                    ...
                                    <div class="btn-group" role="group"> <a href=".themetab" aria-controls="themetab" role="tab" data-toggle="tab" class="btn btn-default btn-dblue">Theme</a> </div>
                                    <div class="btn-group hide" role="group"> <a href=".csstab" aria-controls="csstab" role="tab" data-toggle="tab" class="btn btn-default btn-dblue">css</a> </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class='row row-eq-height'>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane validation p-10" id="validation">
                                    ...
                                    <div class="form-group col-md-10  p-0">
                                        ...
                                        <input type="email" class="form-control" id="errorMessage" placeholder="Please enter a value" data-field="errorMessage">
                                    </div>
                                </div>
                                <div role="tabpanel" class="tab-pane themetab " id="themetab">
                                    <div class="form-inline col-md-12 p-0">
                                        ...
                                        <input type="text" class="form-control" id="editClassname" data-field="classname" placeholder="Default">
                                    </div>
                                    <div class="form-inline col-md-12 p-0">
                                        <div class="dib wid-50">
                                    ...
                                    <div class="form-inline col-md-12 p-0">
                                        ...
                                        <div class="dib vt mr-5">
                                            <div class="input-group input-color csscolor-picker" data-colortype="input-background">
                                                <input type="text" class="form-control hide" id="editbackground" data-field="input-background" placeholder="Text here" value="">
                                                <div class="input-group-addon"><i></i></div>
                                            </div>
                                        </div>
                                        <div class="dib vt mr-5">Border</div>
                                        <div class="dib vt mr-5">
                                            <div class="input-group input-color csscolor-picker" data-colortype="input-border-color">
                                                <input type="text" class="form-control hide" id="editbordercolor" data-field="input-border-color" placeholder="Text here" value="">
                                                <div class="input-group-addon"><i></i></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-inline col-md-12 p-0">
                                        ...
                                        <div class="dib vt mr-5">
                                            <div class="input-group input-color csscolor-picker" data-colortype="input-color">
                                                <input type="text" class="form-control hide" id="editcolor" data-field="input-color" placeholder="Text here" value="">
                                                <div class="input-group-addon"><i></i></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-inline col-md-12 p-0">
                                        ...
                                        <input type="text" class="form-control small-theme-text" id="" data-field="animation-delay" placeholder="0.1" value="0.1">
                                        <label for="animationDuration" class="ml-20">Duration</label>
                                        <input type="text" class="form-control small-theme-text" id="" data-field="animation-duration"  placeholder="0.1" value="0.9">
                                    </div>
                                    <hr class="p-t-10">
                                    <div class="form-inline col-md-12 p-0 text-right">

                                        <button type="button" class="btn btn-default btn-success" data-action="saveassetting">Save as new Setting</button>
                                    </div>
                                </div>
                                <div role="tabpanel" class="tab-pane csstab  p-10" id="csstab">
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <label for="editbackground" class="width-150"><i class="fa fa-play mr-5 f-12"></i>Background Color</label>
                                            <div class="input-group input-color csscolor-picker" data-colortype="background">
                                                <input type="text" class="form-control hide" id="editbackground" data-field="background" placeholder="Text here" value="">
                                                <div class="input-group-addon"><i></i></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-color csscolor-picker"  data-colortype="color">
                                                <input type="text" class="form-control hide" id="editcolor" data-field="color" placeholder="Text here" value="">
                                                <div class="input-group-addon"><i></i></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <label for="editBackgound" class="width-150"><i class="fa fa-play mr-5 f-12"></i>Border Color</label>
                                            <div class="input-group input-color csscolor-picker"  data-colortype="border-color">
                                                <input type="text" class="form-control hide" id="editBackgound" data-field="border-color" placeholder="Text here" value="">
                                                <div class="input-group-addon"><i></i></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-6 p-t-10">
                                                ...
                                                <input type="text" class="form-control hide" id="editpadding" data-field="padding-top" placeholder="Text here" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <label for="editpaddingbottom" class="col-xs-6 width-150 p-l-0 "><i class="fa fa-play mr-5 f-12"></i>Padding-bottom</label>
                                            <div class="col-xs-6 p-t-10">
                                                <div class="filedSlider" data-slidertype="padding-bottom"></div>
                                                <input type="text" class="form-control hide" id="editpaddingbottom" data-field="padding-bottom" placeholder="Text here" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <label for="editpaddingleft" class="col-xs-6 width-150 p-l-0 "><i class="fa fa-play mr-5 f-12"></i>Padding-Left</label>
                                            <div class="col-xs-6 p-t-10">
                                                <div class="filedSlider" data-slidertype="padding-left"></div>
                                                <input type="text" class="form-control hide" id="editpaddingleft" data-field="padding-left" placeholder="Text here" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <label for="editpaddingright" class="col-xs-6 width-150 p-l-0 "><i class="fa fa-play mr-5 f-12"></i>Padding-right</label>
                                            <div class="col-xs-6 p-t-10">
                                                <div class="filedSlider" data-slidertype="padding-right"></div>
                                                <input type="text" class="form-control hide" id="editpaddingright" data-field="padding-right" placeholder="Text here" value="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class='col-xs-6 right-side popuppreview p-t-40'><div data-frompre='preview'></div></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <div class="row toolbarNav">
                        <div class="col-md-8">
                            <div class="form-horizontal">
                                <div class="btn-group btn-group-justified" role="group" aria-label="..." data-tool-tab="btnpanel">
                                    <div class="btn-group" role="group"> <a href=".rowbackground" aria-controls="General" role="tab" data-toggle="tab" class="btn btn-default btn-dblue active">Background</a> </div>
                                    <div class="btn-group" role="group"> <a href=".margins" aria-controls="margins" role="tab" data-toggle="tab" class="btn btn-default btn-dblue">Margins</a> </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 text-right"> <a  data-dismiss="modal" aria-label="Close" class="btn btn-default btn-default-gray" data-action="discard">Discard</a> <a href="#" class="btn btn-danger btn-danger-red" data-action="applyrow">Apply</a>
                    ...
                    <div class='row'>
                        <div class='col-xs-6 left-side'>
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane margins  p-10" id="csstab">
                                    ...
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <label for="editpadding" class="col-xs-6 width-150 p-l-0 "><i class="fa fa-play mr-5 f-12"></i>From Top</label>
                                            <div class="col-xs-6 p-t-10">
                                                <div class="editfromtop" data-slidertype="from-top"></div>
                                                <input type="text" class="form-control hide" id="editfromtop" data-field="from-top" placeholder="Text here" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <label for="editfrombottom" class="col-xs-6 width-150 p-l-0 "><i class="fa fa-play mr-5 f-12"></i>From-bottom</label>
                                            <div class="col-xs-6 p-t-10">
                                                <div class="filedSlider" data-slidertype="from-bottom"></div>
                                                <input type="text" class="form-control hide" id="editfrombottom" data-field="from-bottom" placeholder="Text here" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <label for="editfromright" class="col-xs-6 width-150 p-l-0 "><i class="fa fa-play mr-5 f-12"></i>From-Right</label>
                                            <div class="col-xs-6 p-t-10">
                                                <div class="filedSlider" data-slidertype="from-right"></div>
                                                <input type="text" class="form-control hide" id="editfromright" data-field="from-right" placeholder="Text here" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <label for="editFromleft" class="col-xs-6 width-150 p-l-0 "><i class="fa fa-play mr-5 f-12"></i>From-Left</label>
                                            <div class="col-xs-6 p-t-10">
                                                <div class="filedSlider" data-slidertype="from-left"></div>
                                                <input type="text" class="form-control hide" id="editFromleft" data-field="from-left" placeholder="Text here" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <h5>Inner Margins:</h5>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <label for="edithorizontal" class="col-xs-6 width-150 p-l-0 "><i class="fa fa-play mr-5 f-12"></i>horizontal</label>
                                            <div class="col-xs-6 p-t-10">
                                                <div class="filedSlider" data-slidertype="horizontal"></div>
                                                <input type="text" class="form-control hide" id="edithorizontal" data-field="horizontal" placeholder="Text here" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <label for="editvertical" class="col-xs-6 width-150 p-l-0 "><i class="fa fa-play mr-5 f-12"></i>Vertical</label>
                                            <div class="col-xs-6 p-t-10">
                                                <div class="filedSlider" data-slidertype="vertical"></div>
                                                <input type="text" class="form-control hide" id="editvertical" data-field="vertical" placeholder="Text here" value="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class='col-xs-6 right-side popuppreview p-t-40'><div data-frompre='rowpreview' class="boxpreivewRow row" style="padding:0;">
                                <div class="col-xs-6" style="padding:0;">
                                    <div class="boxpreivew bg-blue-lighter"></div>
                                </div>
                                <div class="col-xs-6" style="padding:0;"><div class="boxpreivew bg-black-lighter"></div></div>
                                <div class="col-xs-6" style="padding:0;"><div class="boxpreivew bg-red-lighter"></div></div>
                                <div class="col-xs-6" style="padding:0;"><div class="boxpreivew bg-green-lighter"></div></div>
                            </div></div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="row toolbarNav">
                        <div class="col-md-8">
                            <div class="form-horizontal">
                                <div class="btn-group btn-group-justified" role="group" aria-label="..." data-tool-tab="btnpanel">
                                    <div class="btn-group" role="group"> <a href=".onSubmitFrom" aria-controls="General" role="tab" data-toggle="tab" class="btn btn-default btn-dblue active">On submit</a> </div>
                                    <div class="btn-group" role="group"> <a href=".hiddenfields" aria-controls="margins" role="tab" data-toggle="tab" class="btn btn-default btn-dblue">Hidden Fields</a> </div>
                                    <div class="btn-group" role="group"> <a href=".formRule" aria-controls="margins" role="tab" data-toggle="tab" class="btn btn-default btn-dblue">Rule</a> </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 text-right"> <a  data-dismiss="modal" aria-label="Close" class="btn btn-default btn-default-gray" data-action="discard">Discard</a> <a href="#" class="btn btn-danger btn-danger-red" data-action="applysetpssetting" data-dismiss="modal">Apply</a>
                    ...
                    <div class='row'>
                        <div class="tab-content">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group m-0">
                                        ...
                                        <div class="col-sm-9 form-inline">
                                            <div class="checkbox radio">
                                                <input type="radio" name="postactions" id="postactions1" data-post-action="postaction" value="ajax" checked> <label for="postactions1"> Ajax</label>
                                            </div>
                                            <div class="checkbox radio">
                                                <input type="radio" name="postactions" id="postactions2" data-post-action="postaction" value="custom"> <label  for="postactions2"> Custom</label>
                                            </div>
                                    ...
                                    <div class="hide" data-postaction-container="ajax">
                                        <div class="form-group m-0" >
                                            ...
                                            <div class="col-sm-9 form-inline">
                                                <div class="checkbox radio">
                                                    <input type="radio" name="afterSubmit" id="afterSubmit1" data-post-action="afterSubmit" value="showMessage" checked> <label for="afterSubmit1"> Show Message</label>
                                                </div>
                                                <div class="checkbox radio">
                                                    <input type="radio" name="afterSubmit" id="afterSubmit2" data-post-action="afterSubmit" value="redirect"> <label for="afterSubmit2"> Redirect</label>
                                                </div>
                                        ...
                                        <div class="form-group m-0 hide" data-afterSubmit-container="redirect">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text" class="form-control" id="redirectto" name="redirectto" placeholder="Redirect to">

                                            </div>
                                        </div>

                                        <div class="form-group m-0 hide" data-afterSubmit-container="showMessage">
                                            <label for="postaction" class="col-xs-3 control-label">On-screen confirmation message</label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control" placeholder="On-screen confirmation message"></textarea>
                                    ...
                                    <div class="hide" data-postaction-container="custom">
                                        <div class="form-group m-0">
                                            <label for="postaction" class="col-xs-3 control-label">Submmision method</label>
                                            <div class="col-sm-9 form-inline">
                                                <div class="checkbox radio">
                                                    <input type="radio" name="submmisionmethod" id="submmisionmethod1" value="post" checked> <label for="submmisionmethod1"> Post</label>
                                                </div>
                                                <div class="checkbox radio">
                                                    <input type="radio" name="submmisionmethod" id="submmisionmethod2" value="get"> <label for="submmisionmethod2">Get</label>
                                                </div>
                                        ...
                                        <div class="form-group m-0">
                                            <label for="postaction" class="col-xs-3 control-label">Submit form to</label>
                                            <div class="col-sm-9">

                                                <input type="text" class="form-control" name="submitfromto" id="submitfromto" placeholder="Submit form to">
                            ...
                            <div role="tabpanel" class="tab-pane hiddenfields  p-10" id="hiddenfields">
                                ...
                                <button class="btn btn-default btn-default-gray" type="button" data-action="addHiddenField"><i class="fa fa-plus"></i> Add Hidden Field</button>
                            ...
                            <div role="tabpanel" class="tab-pane formRule  p-10" id="formRule">
                                ...
                                <button class="btn btn-default btn-default-gray" type="button" data-action="addruleField"><i class="fa fa-plus"></i> Add New Rule</button>
                                <div class="hide">
                                    <div class="row" data-html="newCondition">
                                        ...
                                        <div class="form-group col-xs-2 p-0"><button class="btn btn-default" type="button" data-action="removeField"><i class="fa fa-times"></i></button></div>
                                    </div>
                                    <div class="panel panel-default" data-html="newrule">
                                        <div class="panel-heading"><button class="btn btn-default pull-right btn-xs" type="button" data-action="removeRule"><i class="fa fa-times"></i></button> Rule </div>
                                        <div class="panel-body p-l-0 p-r-0">
                                            <div class="col-xs-6">
                                                <h6>
                                                    IF
                                                    <select class="form-control" name="selector" style="width:20%; float:none !important; display: inline">
                                                ...
                                                <button class="btn btn-default" type="button" data-action="addCondition"><i class="fa fa-plus"></i> Add Condition</button>
                                            </div>
                                            <div class="col-xs-6">
                                                <h6>THEN</h6>
                                                <button class="btn btn-default" type="button" data-action="addAction"><i class="fa fa-plus"></i> Add Action</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-body">
                    <div class="row toolbarNav">
                        <div class="col-md-8">
                            <div class="form-horizontal">
                                <div class="btn-group btn-group-justified" role="group" aria-label="..." data-tool-tab="btnpanel">
                                    <div class="btn-group" role="group"> <a href=".themesetting" aria-controls="General" role="tab" data-toggle="tab" class="btn btn-default btn-dblue active">Themes</a> </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 text-right"> <a  data-dismiss="modal" aria-label="Close" class="btn btn-default btn-default-gray" data-action="discard">Discard</a> <a href="#" class="btn btn-danger btn-danger-red" data-action="applythemes" data-dismiss="modal">Apply</a>
                    ...
                    <div class='row'>
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane themesetting active  p-10" id="themesetting">
                                <div class="form-group">
                                    <label for="ChooseColorScheme"><i class="fa fa-play mr-5 f-12"></i> Choose Color Theme  </label>
                                    <select class="form-control customFormSelect" data-width="auto" data-field="choosetheme" >
