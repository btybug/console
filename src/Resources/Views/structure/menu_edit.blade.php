  ...
  <article>
   <div class="col-xs-4 col-sm-4 col-md-3 col-lg-3 col-xl-3" >
    <div id="styles" class="panel_bd_styles">
     {!! hierarchyAdminPagesListWithModuleNameTest($pageGrouped, null, true, $slug) !!}
    </div>
   </div>
...
@section('JS')
 ...
 {!! HTML::script('resources/assets/js/backend-console-createmenu.js') !!}
 ...
 <script>
  ...
  $(document).ready(function(){
   ...
   if ($('#tagits').length > 0){
    ...
    $('#tagits').tagit({availableTags: getExt,
